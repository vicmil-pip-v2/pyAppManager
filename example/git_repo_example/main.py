...
if not os.path.exists(ssh_key_dir):
    app_git_manager.generate_ssh_keypair(ssh_key_dir)
...
if not os.path.exists(clone_dir):
    app_git_manager.clone_private_repo(repo_url, private_ssh_deploy_key, clone_dir, branch)
else:
    app_git_manager.pull_latest_changes(clone_dir, private_ssh_deploy_key)
